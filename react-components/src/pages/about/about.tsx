    ...
    return (
      <Container>
        ...
        <p>
          ...
          テキストでした。 それは 5
          世紀だけでなく、電子組版への飛躍にも耐え、本質的に変わっていません。 1960 年代に Lorem
          Ipsum のパッセージを含む Letraset シートがリリースされ、最近では Lorem Ipsum
          のバージョンを含む Aldus PageMaker のようなデスクトップ パブリッシング
          ソフトウェアで普及しました。
        </p>
        <h3>それはどこから来たのですか？</h3>
        <p>
          ...
          は、紀元前 45 年に書かれたキケロの &quot;de Finibus Bonorum et Malorum&quot;
          (善と悪の極限) のセクション 1.10.32 と 1.10.33 に由来します。
        ...
        <p>
          ...
          の標準的なチャンクを以下に示します。 Cicero による &quot;de Finibus Bonorum et
          Malorum&quot; のセクション 1.10.32 および 1.10.33 も、H. Rackham による 1914
